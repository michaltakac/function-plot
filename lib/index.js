...
module.exports = function(options) {
  ...
  Chart.prototype.initializeAxes = function() {
    ...
    // TODO: support other scales than just d3.scaleLinear
    //OLD CODE --- xScale = this.meta.xScale = d3.scale[options.xAxis.type]()
    xScale = this.meta.xScale = d3
      .scaleLinear()
      .domain(xDomain)
      .range(options.xAxis.invert ? [width, 0] : [0, width]);
    yScale = this.meta.yScale = d3
      .scaleLinear()
      .domain(yDomain)
  ...
  Chart.prototype.internalVars = function() {
    ...
    zoomBehavior = this.meta.zoomBehavior = d3.zoom();
    ...
    canvas
      ...
      .each(function() {
        ...
        var listeners = [
          "mousedown",
          "touchstart",
          "onwheel" in document ? "wheel" : "ononmousewheel" in document ? "mousewheel" : "MozMousePixelScroll",
        ].map(function(d) {
          return d + ".zoom";
        });
      ...
      .tween("zoom", function() {
        ...
        return function(t) {
          ...
          xAxis
            .transition()
            .duration(0)
            .call(xAxis.scale(d3.event.transform.rescaleX(xScale.domain(ix(t)))));
          yAxis
            .transition()
            .duration(0)
            .call(yAxis.scale(d3.event.transform.rescaleX(yScale.domain(iy(t)))));
